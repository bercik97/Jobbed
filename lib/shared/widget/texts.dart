...
Text text12White(String text) { return Text(text, style: GoogleFonts.lato(fontSize: 12, color: WHITE)); }
...
/*    TEXT DARK    */
/////////////////////
Text text18Dark(String text) { return Text(text, style: GoogleFonts.lato(fontSize: 18, color: DARK)); }
...
/*TEXT CENTER DARK */
/////////////////////
Text textCenter12Dark(String text) { return Text(text, textAlign: TextAlign.center, style: GoogleFonts.lato(fontSize: 12, color: DARK)); }


/////////////////////
/* TEXT DARK BOLD  */
/////////////////////
Text textDarkBold(String text) { return Text(text, style: GoogleFonts.lato(color: DARK, fontWeight: FontWeight.bold)); }
...
////////////////////////////
Text textCenterGreenBold(String text) { return Text(text, textAlign: TextAlign.center, style: GoogleFonts.lato(color: GREEN, fontWeight: FontWeight.bold)); }
Text textCenter15GreenBold(String text) { return Text(text, textAlign: TextAlign.center, style: GoogleFonts.lato(fontSize: 15, color: GREEN, fontWeight: FontWeight.bold)); }
...
Text text15GreenBold(String text) { return Text(text, style: GoogleFonts.lato(fontSize: 15, color: GREEN, fontWeight: FontWeight.bold)); }
