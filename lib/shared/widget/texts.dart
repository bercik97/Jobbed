...
Text text12White(String text) { return Text(text, style: TextStyle(fontSize: 12, color: WHITE)); }
...
Text text17WhiteBold(String text) { return Text(text, style: TextStyle(fontSize: 17, color: WHITE, fontWeight: FontWeight.bold)); }
...
Text textCenter15GreenBold(String text) { return Text(text, textAlign: TextAlign.center, style: TextStyle(fontSize: 15, color: GREEN, fontWeight: FontWeight.bold)); }
