...
class WorkdayUtil {
  ...
  static Widget buildWarehouseHistoryDataTable(BuildContext context, List warehouseHistory) {
    return SizedBox.expand(
      child: Scaffold(
        backgroundColor: Colors.black12,
        body: Center(
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Column(
                  children: [
                    text20GreenBold(getTranslated(context, 'warehouseHistory')),
                    SizedBox(height: 20),
                    warehouseHistory.isNotEmpty
                              ...
                              child: Theme(
                                ...
                                child: DataTable(
                                  ...
                                  columns: [
                                    ...
                                    DataColumn(label: textWhiteBold(getTranslated(context, 'action'))),
                                    DataColumn(label: textWhiteBold(getTranslated(context, 'date'))),
                                    DataColumn(label: textWhiteBold(getTranslated(context, 'itemName'))),
                                    DataColumn(label: textWhiteBold(getTranslated(context, 'previousQuantity'))),
                                    DataColumn(label: textWhiteBold(getTranslated(context, 'newQuantity'))),
                                  ],
                                  rows: [
                                    for (int i = 0; i < warehouseHistory.length; i++)
                                      DataRow(
                                        cells: [
                        ...
                        : textWhite(getTranslated(context, 'warehouseHistoryIsEmpty')),
                    SizedBox(height: 20),
                    Container(
                      width: 80,
                      child: MaterialButton(
