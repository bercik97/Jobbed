    ...
    return WillPopScope(
      child: MaterialApp(
        ...
        home: Scaffold(
          ...
          appBar: managerAppBar(context, _user, getTranslated(context, 'itemPlaces'), () => NavigatorUtil.navigateReplacement(context, GroupPage(_model))),
          body: Column(
            children: <Widget>[
              Padding(
                padding: EdgeInsets.only(top: 15, left: 15, right: 15, bottom: 10),
                child: text18Black(getTranslated(context, 'itemPlacePageTitle')),
              ),
              Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          SizedBox(height: 10),
                          IconsLegendUtil.buildImageRow('images/items.png', getTranslated(context, 'itemPlaceDetails')),
                        ],
                      ),
                    ),
                  );
